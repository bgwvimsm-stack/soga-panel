...
async fn post_user_traffic(
    ...
    success(
        json!({ "message": "User traffic reset successfully" }),
        "Success",
    )
    .into_response()
}
...
async fn export_users(
    ...
    for row in rows {
        ...
        let line = [
            ...
            escape_csv(
                row.try_get::<Option<i64>, _>("class")
                    .unwrap_or(Some(0))
                    .unwrap_or(0)
                    .to_string(),
            ),
            ...
            escape_csv(
                row.try_get::<Option<i64>, _>("transfer_today")
                    .unwrap_or(Some(0))
                    .unwrap_or(0)
                    .to_string(),
            ),
            escape_csv(
                row.try_get::<Option<i64>, _>("transfer_total")
                    .unwrap_or(Some(0))
                    .unwrap_or(0)
                    .to_string(),
            ),
            escape_csv(
                row.try_get::<Option<i64>, _>("transfer_enable")
                    .unwrap_or(Some(0))
                    .unwrap_or(0)
                    .to_string(),
            ),
            escape_csv(
                format_datetime(
                    row.try_get::<Option<NaiveDateTime>, _>("reg_date")
                        .ok()
                        .flatten(),
                )
                .unwrap_or_default(),
            ...
            escape_csv(
                format_datetime(
                    row.try_get::<Option<NaiveDateTime>, _>("last_login_time")
                        .ok()
                        .flatten(),
                )
                .unwrap_or_default(),
            ...
            escape_csv(
                format_datetime(
                    row.try_get::<Option<NaiveDateTime>, _>("expire_time")
                        .ok()
                        .flatten(),
                )
                .unwrap_or_default(),
            ...
            escape_csv(
                format_datetime(
                    row.try_get::<Option<NaiveDateTime>, _>("class_expire_time")
                        .ok()
                        .flatten(),
                )
                .unwrap_or_default(),
