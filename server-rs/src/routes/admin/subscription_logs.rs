...
async fn post_export_csv(
    ...
    for row in rows {
        let line = [
            ...
            escape_csv(
                row.try_get::<Option<String>, _>("subscription_type")
                    .ok()
                    .flatten()
                    .unwrap_or_default(),
            ),
            escape_csv(
                row.try_get::<Option<String>, _>("access_ip")
                    .ok()
                    .flatten()
                    .unwrap_or_default(),
            ),
            escape_csv(
                row.try_get::<Option<String>, _>("client_ua")
                    .ok()
                    .flatten()
                    .unwrap_or_default(),
            ),
            escape_csv(
                row.try_get::<Option<NaiveDateTime>, _>("access_time")
                    .ok()
                    .flatten()
